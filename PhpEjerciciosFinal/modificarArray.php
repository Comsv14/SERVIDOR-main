...
// Obtener un documento de la colección para extraer los campos
$documentoEjemplo = $collection->findOne();  // Tomamos un solo documento para obtener los campos

// Extraer los nombres de los campos del documento
$campos = $documentoEjemplo ? array_keys((array) $documentoEjemplo) : [];  // Obtener los campos
    ...
    <form method="post">
        ...
        <div id="modificarCampos">
            ...
            <select name="campo" required>
                <?php
                // Mostrar los campos disponibles de la colección
